...
import com.class2018071002.entity.QuestionState;
...
public class Question implements Comparable<com.class2018071002.entity.Question> {
    ...
    public String toString() {
        ...
        if (getType() == com.class2018071002.entity.QuestionType.SINGLE_CHOICE.ordinal()) {
            stringBuffer.append("单选题:").append("\n");
        }else if (getType() == com.class2018071002.entity.QuestionType.MULTI_CHOICE.ordinal()){
...
//    }
        ...
        @Override
    public int compareTo(com.class2018071002.entity.Question o) {
        if (this.getAddTime() > o.getAddTime()){
            return -1;
        }else if(this.getAddTime() < o.getAddTime()){
            return 1;
