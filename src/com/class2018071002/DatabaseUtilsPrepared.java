...
public class DatabaseUtilsPrepared {
    ...
    public void insertData(){
        try {
            ...
            insertDataUseStatement();

//            insertDataUsePrepared();

//            insertDataUsePreparedSecond();

//            checkResultSet();

//            useJdbcRowSet(url, user, password);
//            useCachedRowSet();
//            useTransaction();


//            useSupportsBatchUpdates();



            PreparedStatement insertExamineePrepared = connection.prepareStatement("insert into examinee(identity_card_number,name,password,gender,license_type,examinee_status,add_time,update_time) values(?,?,?,?,?,?,?,?)");
            insertExamineePrepared.setString(1,"429004199707289091");
            insertExamineePrepared.setString(2,"范良策");
            insertExamineePrepared.setString(3,"");
            insertExamineePrepared.setInt(3,Gender.MALE.ordinal());
            insertExamineePrepared.setInt(4,LicenseType.C1.ordinal());
            insertExamineePrepared.setInt(5,ExamineeStatus.SIGN_UP.ordinal());
            insertExamineePrepared.setLong(6,System.currentTimeMillis());
            insertExamineePrepared.setLong(7,System.currentTimeMillis());
            insertExamineePrepared.executeUpdate();


            PreparedStatement selectExamineePrepared2 = connection.prepareStatement("select * from hm_user where user_id = ? and user_password = ?;");
            selectExamineePrepared2.setLong(1,1112L);
            selectExamineePrepared2.setString(2,"aaa'or '1'='1'");
    ...
    public void useSupportsBatchUpdates() throws SQLException {
        DatabaseMetaData metaData = connection.getMetaData();
        boolean b = metaData.supportsBatchUpdates();
        System.out.println("supportsBatchUpdates==" + b);
    }
    ...
    public void useCachedRowSet() throws SQLException {
        ResultSet resultSet = statement.executeQuery("select * from examinee;");

        RowSetFactory factory = RowSetProvider.newFactory();
        CachedRowSet cachedRowSet = factory.createCachedRowSet();
        cachedRowSet.setPageSize(10);
        cachedRowSet.populate(resultSet,(2-1)*10 +1);
        resultSet.close();
        statement.close();
        connection.close();
...
//            cachedRowSet.acceptChanges(connection);
    ...
    public void useJdbcRowSet(String url, String user, String password) throws SQLException {
        RowSetFactory factory = RowSetProvider.newFactory();
        JdbcRowSet jdbcRowSet = factory.createJdbcRowSet();
        jdbcRowSet.setUrl(url);
        jdbcRowSet.setUsername(user);
        jdbcRowSet.setPassword(password);
        jdbcRowSet.setCommand("select * from examinee;");
        jdbcRowSet.execute();
    ...
    public void checkResultSet() throws SQLException {
        PreparedStatement preparedStatement = connection.prepareStatement("select * from examinee",ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE);
    ...
    public void insertDataUsePreparedSecond(){
        try {
//            PreparedStatement dropPrepared = connection.prepareStatement("drop database if exists [?];");
////            PreparedStatement dropPrepared = connection.prepareStatement("drop database if exists driver_test_prepared");
//            dropPrepared.setString(1,Constant.DATABASE);
//
//
//            dropPrepared.execute();

            PreparedStatement insertExamineePrepared = connection.prepareStatement("insert into examinee(identity_card_number,name,gender,license_type,examinee_status,add_time,update_time) values(?,?,?,?,?,?,?)");
            insertExamineePrepared.setString(1,"429004199707289091");
            insertExamineePrepared.setString(2,"范良策");
            insertExamineePrepared.setInt(3,Gender.MALE.ordinal());
            insertExamineePrepared.setInt(4,LicenseType.C1.ordinal());
    ...
    public void insertDataUsePrepared() throws SQLException {
...
//        PreparedStatement createQuestion = connection.prepareStatement()


        PreparedStatement insertQuestionPrepare = connection.prepareStatement("insert into questions(type,scope,stem,option_a,option_b,option_c,option_d,question_key,explanation,state,add_time,update_time) values(?,?,?,?,?,?,?,?,?,?,?,?);");
        insertQuestionPrepare.setInt(1, QuestionType.SINGLE_CHOICE.ordinal());
        insertQuestionPrepare.setString(2,"all");
        insertQuestionPrepare.setString(3,"夜间驾驶机动车遇对方使用远光灯，无法看清前方路况时，以下做法正确的是什么？");
        insertQuestionPrepare.setString(4,"A、自己也打开远光灯行驶");
        insertQuestionPrepare.setString(5,"B、降低车速，谨慎会车");
        insertQuestionPrepare.setString(6,"C、加速通过，尽快摆脱眩目光线");
        insertQuestionPrepare.setString(7,"D、保持行驶方向和车速不变");
        insertQuestionPrepare.setString(8,"B");
        insertQuestionPrepare.setString(9,"夜间驾驶机动车遇对方使用远光灯，无法看清前方路况时，降低车速，谨慎会车，以免发生车祸、危险。");
        insertQuestionPrepare.setInt(10, com.class2018071002.entity.QuestionState.ADDED.ordinal());
        insertQuestionPrepare.setLong(11,System.currentTimeMillis());
        insertQuestionPrepare.setLong(12,System.currentTimeMillis());
        insertQuestionPrepare.executeUpdate();
    ...
    public void insertDataUseStatement() throws SQLException {
        StringBuffer dropDatabase = new StringBuffer();
        dropDatabase.append("drop database if exists ").append(Constant.DATABASE).append(";");
        statement.execute(dropDatabase.toString());
...
//        PreparedStatement createPrepared = connection.prepareStatement("create table ? ()")
        ...
        insertQuestion.append("insert into ").append(Constant.TABLE_QUESTIONS).append("(").append(Constant.TYPE).append(",").append(Constant.SCOPE).append(",").append(Constant.STEM).append(",").append(Constant.OPTION_A).append(",").append(Constant.OPTION_B).append(",").append(Constant.OPTION_C).append(",")
                ...
                .append(QuestionType.SINGLE_CHOICE.ordinal()).append(",")
                .append("\'all\',")
...
//        statement.execute(insertQuestion.toString());
        ...
        insertExaminee.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.PASSWORD).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'429004199707289091\',").append("\'范良策\',").append("\'12345678\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
...
//        insertExamineePrepared.executeUpdate();
    ...
    public void insertOtherExaminee() throws SQLException {
        ...
        insertExaminee2.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'542126198505035798\',").append("\'谭星雨\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee3.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'410301198010269202\',").append("\'周以旋\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
...
//        statement.execute(insertExaminee5.toString());
        ...
        insertExaminee6.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'500104197212181095\',").append("\'董正雅\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee7.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'622222197406027579\',").append("\'任嘉祥\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee8.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'422802198012273368\',").append("\'王秋荷\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee9.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'430601198601247179\',").append("\'程奇思\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee10.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'511321198801279837\',").append("\'林德佑\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee11.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'450621199706204056\',").append("\'贾高芬\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee12.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'530324199805272989\',").append("\'覃又柔\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee13.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'420205198309100796\',").append("\'姜博文\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee14.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'440700197608166220\',").append("\'冯天晴\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee15.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'142625198411284431\',").append("\'罗力学\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee16.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'542334198707056547\',").append("\'孟凌晴\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee17.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'362430199008310674\',").append("\'于烨煜\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee18.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'420103197712062715\',").append("\'贾良奥\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee19.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'370304197504216815\',").append("\'蔡勇男\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee20.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'450881199412087728\',").append("\'仇楚云\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee21.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'411081199004235955\',").append("\'王正伟\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee22.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'420821199206305032\',").append("\'罗江超\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee23.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'450326198912241844\',").append("\'张玉婷\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee24.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'432922198008015828\',").append("\'唐琳雅\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee25.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'450881199006112350\',").append("\'潘海林\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee26.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'612422199608063226\',").append("\'易茜茜\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee27.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'450103197912150539\',").append("\'廖韵\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee28.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'430111199010150308\',").append("\'江文静\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee29.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'330205197909244850\',").append("\'柳华清\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee30.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'522229197508122084\',").append("\'贾惠群\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee31.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'362422197105146213\',").append("\'陈显君\',").append(Gender.FAMALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
        ...
        insertExaminee32.append("insert into ").append(Constant.TABLE_EXAMINEE).append("(").append(Constant.IDENTITY_CARD_NUMBER).append(",").append(Constant.NAME).append(",").append(Constant.GENDER).append(",").append(Constant.LICENSE_TYPE).append(",").append(Constant.EXAMINEE_STATUS).append(",").append(Constant.ADD_TIME).append(",").append(Constant.UPDATE_TIME).append(") values(")
                .append("\'430281198910125618\',").append("\'文新业\',").append(Gender.MALE.ordinal()).append(",").append(LicenseType.C1.ordinal()).append(",").append(ExamineeStatus.SIGN_UP.ordinal()).append(",").append(System.currentTimeMillis()).append(",").append(System.currentTimeMillis()).append(");");
